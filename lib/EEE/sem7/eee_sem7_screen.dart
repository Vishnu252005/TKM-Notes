...
import 'package:Nexia/EEE/sem7/units.dart'; // Import the correct file for units
...
class EEESem7Screen extends StatefulWidget {//n
  ...
  @override
  _EEESem7ScreenState createState() => _EEESem7ScreenState();
}

class _EEESem7ScreenState extends State<EEESem7Screen> {
  ...
  void initState() {
    ...
    _subjects = {
      'Notes & Books': [
        {
          ...
          'description': 'Analysis of power systems and their components...',
          'image': 'assets/s1.png',
        ...
        },
        {
          ...
          'description':
              'Design principles and practices for electrical systems...',
          'image': 'assets/s1.png',
          'page': () => ComputerNetworksPage(fullName: widget.fullName),
        },
      ],
      'PYQs': [
        {
          'name': 'Power System Analysis PYQs',
          'description': 'Previous Year Questions for Power System Analysis...',
          'image': 'assets/s2.png',
          'page': () => ComputerNetworksPage(fullName: widget.fullName),
        },
        {
          'name': 'Electrical System Design PYQs',
          'description':
              'Previous Year Questions for Electrical System Design...',
          'image': 'assets/s2.png',
          'page': () => ComputerNetworksPage(fullName: widget.fullName),
        },
      ],
