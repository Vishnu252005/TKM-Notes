...
class Esd1 extends StatefulWidget {
  ...
  @override
  _EsdState createState() => _EsdState();
}

class _EsdState extends State<Esd1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Codes of practice',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Lighting Schemes and calculations',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Domestic Installation',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Industrial Power and Lighting Installations',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: High Rise buildings',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
