...
class Psd1 extends StatefulWidget {
  ...
  @override
  _PsdState createState() => _PsdState();
}

class _PsdState extends State<Psd1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: FUNDAMENTALS OF ELECTRIC DRIVES',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: RECTIFIER CONTROL OF DC DRIVES',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: CONTROL OF DC MOTORS BY CHOPPERS',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: THREE PHASE INDUCTION MOTOR DRIVES',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: SYNCHRONOUS MOTOR DRIVES',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
