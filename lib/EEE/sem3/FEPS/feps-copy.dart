...
class Feps1 extends StatefulWidget {
  ...
  @override
  _FepsState createState() => _FepsState();
}

class _FepsState extends State<Feps1> {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE III: Design of power transmission system components',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
