...
class Bee1 extends StatefulWidget {
  ...
  Bee1({
    ...
    required this.subjectName,  // Add this to constructor
  });
...
class _BeeState extends State<Bee1> {
