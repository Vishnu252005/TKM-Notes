...
class fec extends StatelessWidget {
  ...
  fec({required this.fullName, required this.branch, required this.year, required this.semester}); // Constructor accepting fullName
