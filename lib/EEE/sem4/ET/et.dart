...
class _EtState extends State<Et> {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Coordinate systems and vector calculus',
      isAvailable: false,
      pdfUrl:
          'https://drive.google.com/uc?id=1gxS0SpG9Om8zVGxrX9vZAm53AF0gL-3u&export=download',
    ),
    UnitItem(
    ...
    UnitItem(
      title: 'MODULE III: Magnetostatics and time varying fields',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Electromagnetic waves',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Wave propagation through transmission lines',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
