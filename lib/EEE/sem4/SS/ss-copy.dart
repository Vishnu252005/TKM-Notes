...
class Ss1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE III: Fourier representation and sampling of signals',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Discrete domain representation of signals and systems',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Discrete convolution and z transform analysis',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Ss1({required this.fullName}); // Constructor accepting fullName
