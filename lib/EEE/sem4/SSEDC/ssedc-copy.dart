...
class Ssedc1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title:
          'MODULE I: h-parameter model of ce amplifier, biasing of JFET and MOSFET amplifiers',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title:
          'MODULE II: Frequency response of Amplifiers, Multistage amplifiers and Power amplifiers',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
  ...
  Ssedc1({required this.fullName}); // Constructor accepting fullName
