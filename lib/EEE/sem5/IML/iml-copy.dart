...
class Iml1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title:
          'MODULE III: Neural Networks (NN) and Support Vector Machines (SVM)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
  ...
  Iml1({required this.fullName}); // Constructor accepting fullName
