...
class Iml1 extends StatefulWidget {
  ...
  @override
  _ImlState createState() => _ImlState();
}

class _ImlState extends State<Iml1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Overview of machine learning',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
    ...
    UnitItem(
      title: 'MODULE III: Neural Networks (NN) and Support Vector Machines (SVM)',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Unsupervised Learning',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Classification Assessment',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
