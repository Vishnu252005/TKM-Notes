...
class Iem1 extends StatefulWidget {
  ...
  @override
  _IemState createState() => _IemState();
}

class _IemState extends State<Iem1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Evolution of Scientific Management and Industrial Engineering',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Organising for decision making',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Introduction to financial management',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Performance rating and Methods',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Quality Engineering',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
