...
class Am1 extends StatefulWidget {
...
class _AmState extends State<Am1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Fundamentals of Alternators',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Performance characteristics of alternators',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Three Phase AC Motors',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Performance characteristics of three phase induction motors',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Single Phase Induction Motors and Induction Generator',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
