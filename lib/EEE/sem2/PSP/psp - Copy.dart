...
class Psp1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
  UnitItem(
    title: 'MODULE I: Basics of Computer Hardware and Software',
    isAvailable: true,
    pdfUrl: 'https://drive.google.com/file/d/1CAy9yrHksn3w6s91ZfHxG7zmf4oxcuSn/view?usp=sharing',
  ),
  UnitItem(
    title: 'MODULE II: Program Basics',
    isAvailable: true,
    pdfUrl: 'https://drive.google.com/file/d/19wFcQRs2SQo1cc3EB34cuiAAqFUZ581R/view?usp=sharing',
  ),
  UnitItem(
    title: 'MODULE III: Arrays and Strings',
    isAvailable: true,
    pdfUrl: 'https://drive.google.com/file/d/18B2R5vwarQF7EmH7OjeYGFNTjfXuHJH3/view?usp=sharing',
  ),
  UnitItem(
    title: 'MODULE IV: Working with Functions',
    isAvailable: true,
    pdfUrl: 'https://drive.google.com/file/d/1Y2XLmTWCVf6zYDyK3dK70WHwEv4XnQz2/view?usp=sharing',
  ),
  UnitItem(
    title: 'MODULE V: Pointers and Files',
    isAvailable: true,
    pdfUrl: 'https://drive.google.com/file/d/1-l6EprZBLINB2MSVkEQaBSpzuOBZeuty/view?usp=sharing',
  ),
];


  Psp1({required this.fullName}); // Constructor accepting fullName
