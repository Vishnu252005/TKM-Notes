...
import 'package:flutter_application_2/widgets/pdfviewer.dart';
 // upload the link with export = download =  id in a way nly make it to this way 
class Psp extends StatelessWidget {
  ...
  Psp({required this.fullName}); // Constructor accepting fullName
