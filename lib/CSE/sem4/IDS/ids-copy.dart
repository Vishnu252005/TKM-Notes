...
class Ids1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Introduction & Entity Relationship Model',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Relational Model and SQL DDL',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III:  SQL DML and Physical Data Organization',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Database Normalization',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Transactions, Concurrency and Recovery, NoSQL, JDBC ',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Ids1({required this.fullName}); // Constructor accepting fullName
