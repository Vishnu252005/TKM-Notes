...
class Ob1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I:  Introduction to Organizational behavior ',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II:  Cognitive Processes of Organizational behavior',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III:  Communication, Decision making, Stress and Conflict',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Empowerment and Team work',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V:  Leadership and Organizational Culture ',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Ob1({required this.fullName}); // Constructor accepting fullName
