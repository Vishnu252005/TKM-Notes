...
class LSD1 extends StatefulWidget {
  ...
  @override
  _LSDState createState() => _LSDState();
}

class _LSDState extends State<LSD1> {
  ...
  final List<UnitItem> units = [
    UnitItem(
      ...
      isAvailable: true,
      pdfUrl:
          'https://drive.google.com/drive/folders/13KHyg323bWWWHIEkWDA2loFlZfyej4Fh',
    ),
    UnitItem(
