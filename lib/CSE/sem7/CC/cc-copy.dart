...
class Cc1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Fundamental Cloud Computing',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Virtualization',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Cloud-Enabling Technologies, Private cloud platforms and programming',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Amazon Web Services',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Google Cloud Platform and Microsoft Azure',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Cc1({required this.fullName}); // Constructor accepting fullName
