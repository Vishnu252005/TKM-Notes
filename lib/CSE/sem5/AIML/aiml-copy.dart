...
class Aiml1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Overview of Artificial Intelligence',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Overview of machine learning',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Logistic Regression and Neural Networks',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Kernel machines and Instant Based Learning',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Bayesian method and Unsupervised learning',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Aiml1({required this.fullName}); // Constructor accepting fullName
