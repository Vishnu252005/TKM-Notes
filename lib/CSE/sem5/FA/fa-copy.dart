...
class Fa1 extends StatefulWidget {
...
class _FaState extends State<Fa1> {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE II: Finance Planning',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Investment Fundamentals',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Personal Taxation',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Dynamics of Real Estate and Retirement Planning',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
