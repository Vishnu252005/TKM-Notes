...
class Coi1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE V: <<Electoral process, emergency provisions and amendmentprocedure>>',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Coi1({required this.fullName}); // Constructor accepting fullName
