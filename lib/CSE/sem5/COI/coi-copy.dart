...
class Coi1 extends StatefulWidget {
  ...
  @override
  _CoiState createState() => _CoiState();
}

class _CoiState extends State<Coi1> {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE III: Union Executive and the Parliament',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: State Executive and the State legislature',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Electoral process, emergency provisions and amendment procedure',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
