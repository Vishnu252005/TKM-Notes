...
class Tw1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE II: Research paper writing',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Thesis writing',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Tools and Techniques',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Miscellaneous Reports',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

Tw1({required this.fullName}); // Constructor accepting fullName
