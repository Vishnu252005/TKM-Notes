...
class Dsa1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE IV: Sorting and memory allocation',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Hashing table',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Dsa1({required this.fullName}); // Constructor accepting fullName
