...
class Ap1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Basics of object oriented concepts and java',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Fundamentals of core java',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Inheritance, Polymorphism',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Collection framework and exception handling',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Event handling and GUI programming',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Ap1({required this.fullName}); // Constructor accepting fullName
