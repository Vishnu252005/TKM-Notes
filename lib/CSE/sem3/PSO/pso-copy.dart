...
class Pso1 extends StatefulWidget {
  ...
  @override
  _PsoState createState() => _PsoState();
}

class _PsoState extends State<Pso1> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Random variable',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Probability distributions',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Introduction to statistics',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Applied statistics',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Optimization techniques',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
