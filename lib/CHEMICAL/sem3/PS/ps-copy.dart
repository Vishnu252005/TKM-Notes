...
class Ps1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Safety Introduction',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Fundamentals of Fire Processes',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Hazards in the Process Industries',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Personal Protection in Work Environment',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Case Study of Some Major Accidents in the World',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Ps1({required this.fullName}); // Constructor accepting fullName
