...
class Mebc1 extends StatefulWidget {
  ...
  @override
  _MebcState createState() => _MebcState();
}

class _MebcState extends State<Mebc1> {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Solids, Gases, Vapours, and Liquids',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Material Balances for Unit Operations',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Material Balances for Reactive Processes',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Energy Balance on Nonreactive Processes',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Energy Balance on Reactive systems',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
