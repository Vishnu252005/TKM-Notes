...
class Hcrd1 extends StatefulWidget {
  ...
  @override
  _HcrdState createState() => _HcrdState();
}

class _HcrdState extends State<Hcrd1> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Basics of non-ideal flow',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Non catalytic systems',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Catalysis',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Solid Catalyzed Reactions',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Performance equation FOR DIFFERENT REACTION SYSTEMS',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
