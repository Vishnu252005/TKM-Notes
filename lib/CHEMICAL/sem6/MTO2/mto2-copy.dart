...
class Mto21 extends StatefulWidget {
  ...
  @override
  _Mto2State createState() => _Mto2State();
}

class _Mto2State extends State<Mto21> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Liquid-Liquid Extraction and purification',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Leaching and Membrane separation',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Adsorption Operations',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Humidification',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Drying and Crystallization Operations',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
