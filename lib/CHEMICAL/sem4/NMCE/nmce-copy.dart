...
class Nmce1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title:
          'MODULE III: Numerical interpolation, integration and differentiation',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
  ...
  Nmce1({required this.fullName}); // Constructor accepting fullName
