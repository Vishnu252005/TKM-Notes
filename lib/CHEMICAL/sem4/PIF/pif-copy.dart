...
class Pif1 extends StatefulWidget {
  ...
  @override
  _PifState createState() => _PifState();
}

class _PifState extends State<Pif1> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Introduction to Piping',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Piping components',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Piping and Instrumentation Diagrams (P&IDs)',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Piping and Instrumentation Diagram Development',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Instrumentation and Control Devices',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
                  ...
                  builder: (BuildContext context, double value, Widget? child) {
                    return Transform.translate(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Piping and Instrumentation Fundamentals',
                            style: TextStyle(
                              fontSize: 24,
