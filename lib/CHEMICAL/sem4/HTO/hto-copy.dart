...
class Hto extends StatefulWidget {
  ...
  @override
  _HtoState createState() => _HtoState();
}

class _HtoState extends State<Hto> {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Conduction',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Convection',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Radiation, Boiling and Condensation',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Heat Exchangers',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Evaporators',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
