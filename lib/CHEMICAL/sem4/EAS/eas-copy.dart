...
import 'package:flutter_application_2/CIVIL/sem4/ES/es-copy.dart';
import 'package:flutter_application_2/widgets/profile.dart';
import 'package:flutter_application_2/widgets/pdfviewer.dart';

class Eas1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Introduction to Entrepreneurship',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Identifying opportunities and Business Plan',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Start-up Legal issues',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Startup Financial issues',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title:
          'MODULE V: Starting up- The Human angle, Venture Survival and Growth',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Eas1({required this.fullName}); // Constructor accepting fullName
