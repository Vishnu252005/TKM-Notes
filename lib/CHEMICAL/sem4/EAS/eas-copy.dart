...
class Eas1 extends StatefulWidget {
  ...
  @override
  _EasState createState() => _EasState();
}

class _EasState extends State<Eas1> {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE V: Starting up- The Human angle, Venture Survival and Growth',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
