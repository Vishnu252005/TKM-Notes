...
class Cet1 extends StatefulWidget {
  ...
  @override
  _CetState createState() => _CetState();
}

class _CetState extends State<Cet1> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Thermodynamic system and First law of thermodynamics',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Second law of thermodynamics, Equation of States (EOS) & Property relations',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Phase Equilibria',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Activity Coefficient model & Applications of Phase equilibria',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Chemical reaction equilibria',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
