...
class Cet1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title:
          'MODULE II: Second law of thermodynamics, Equation of States (EOS) & Propertyrelations',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
    ...
    UnitItem(
      title:
          'MODULE IV: Activity Coefficient model & Applications of Phase equilibria',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
  ...
  Cet1({required this.fullName}); // Constructor accepting fullName
