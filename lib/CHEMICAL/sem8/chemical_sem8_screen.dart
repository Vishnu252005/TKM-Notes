...
import 'package:flutter_application_2/CHEMICAL/sem8/units.dart';  // Import the correct file for units
import 'package:flutter_application_2/widgets/profile.dart'; // Import the profile.dart file

class CHEMICALSem8Screen extends StatefulWidget {
  final String fullName;
  final String branch;
  final String year;
  final String semester;

  const CHEMICALSem8Screen({
    Key? key,
  ...
  @override
  _CHEMICALSem8ScreenState createState() => _CHEMICALSem8ScreenState();
}

class _CHEMICALSem8ScreenState extends State<CHEMICALSem8Screen> {
