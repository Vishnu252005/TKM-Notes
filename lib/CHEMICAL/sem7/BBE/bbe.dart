...
class Bbe extends StatefulWidget {
  ...
  @override
  _BbeState createState() => _BbeState();
}

class _BbeState extends State<Bbe> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Microbiology and chemicals of life',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Kinetics of Enzyme catalyzed reactions',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Enzyme Immobilization and Metabolic pathways',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Transport phenomena in Bioprocess and bioreactors',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Fermentation technology and biosensors',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
