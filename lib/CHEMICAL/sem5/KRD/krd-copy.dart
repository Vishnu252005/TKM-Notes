...
class Krd1 extends StatefulWidget {
  ...
  @override
  _KrdState createState() => _KrdState();
}

class _KrdState extends State<Krd1> {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE II: Non-Elementary Reactions',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Homogeneous Reactions & Design of Ideal Reactors',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Multiple Reactor Systems & Design Of Reactors',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Non-Isothermal Reactors',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
