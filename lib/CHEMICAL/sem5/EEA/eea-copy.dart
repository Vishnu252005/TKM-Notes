...
class Eea1 extends StatefulWidget {
  ...
  @override
  _EeaState createState() => _EeaState();
}

class _EeaState extends State<Eea1> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Energy Scenario',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Energy Conservation act and related policies',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Energy management and audit',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Concepts of Environmental Impact Assessment',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Environmental Audit',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
