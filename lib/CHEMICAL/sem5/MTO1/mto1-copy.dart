...
class Mto11 extends StatefulWidget {
  ...
  @override
  _Mto1State createState() => _Mto1State();
}

class _Mto1State extends State<Mto11> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Molecular Diffusion and Fundamentals',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Gas-Liquid contacting equipments',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Gas-Liquid Absorption',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Distillation Fundamentals',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Design of Distillation Column',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
