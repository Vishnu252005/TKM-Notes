...
class Tp1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE II: Steady State Shell Momentum Balances',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Steady State Shell Energy Balances',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Steady State Shell Mass Balances',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Analogies Between Momentum, Heat And Mass Transport &Equations Of Change',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Tp1({required this.fullName}); // Constructor accepting fullName
