...
class Emci1 extends StatefulWidget {
  ...
  @override
  _EmciState createState() => _EmciState();
}

class _EmciState extends State<Emci1> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Equivalence and cost comparisons',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Cost estimation',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Profitability analysis',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Breakeven and minimum cost analysis',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Principles of accounting',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
