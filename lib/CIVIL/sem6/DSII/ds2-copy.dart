...
class Ds21 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title:
          'MODULE I: (Limit state of serviceability, Introduction to earthquake-resistant design)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: (steel structures - Connections)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: (Tension members)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: (Compression members)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: (Beams and Roof Truss)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Ds21({required this.fullName}); // Constructor accepting fullName
