...
import 'package:Nexia/CSE/sem4/ES/es-copy.dart';
...
class Cbnt1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: (Linear and Nonlinear Equations)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: (Approximation, Data smoothening and Integration)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: (Ordinary Differential Equations)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: (Partial Differential Equations)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: (Introduction to FEM)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Cbnt1({required this.fullName}); // Constructor accepting fullName
