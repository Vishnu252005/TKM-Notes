...
class Qsv1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: (Quantity Surveying - Basic terms & Terminology)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: (Rates & Specifications)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: (Detailed Estimate - Buildings)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: (Detailed Estimation - Infrastructure)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: (Valuation)',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Qsv1({required this.fullName}); // Constructor accepting fullName
