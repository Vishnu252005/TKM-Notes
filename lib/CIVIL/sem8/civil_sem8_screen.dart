...
import 'package:flutter_application_2/CIVIL/sem8/units.dart';  // Import the correct file for units
import 'package:flutter_application_2/widgets/profile.dart'; // Import the profile.dart file

class CIVILSem8Screen extends StatefulWidget {
  final String fullName;
  final String branch;
  final String year;
  final String semester;

  const CIVILSem8Screen({
    Key? key,
  ...
  @override
  _CIVILSem8ScreenState createState() => _CIVILSem8ScreenState();
}

class _CIVILSem8ScreenState extends State<CIVILSem8Screen> {
