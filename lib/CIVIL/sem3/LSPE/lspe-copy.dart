...
class lspe1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE II: 21st centuary skills and problem solving techniques',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
    ...
    UnitItem(
      title: 'MODULE V: Responsibilities and rights',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  lspe1({required this.fullName}); // Constructor accepting fullName
