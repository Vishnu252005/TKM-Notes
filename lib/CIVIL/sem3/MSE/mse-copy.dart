...
class Mse1 extends StatefulWidget {
  ...
  @override
  _MseState createState() => _MseState();
}

class _MseState extends State<Mse1> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'Module I: Material science',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'Module II: Construction materials',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'Module III: Concrete materials',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'Module IV: Properties of fresh and hardened materials',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'Module V: Modern construction materials',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
