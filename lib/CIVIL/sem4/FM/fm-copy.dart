...
class Fm1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Hydrostatics',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Stability and Hydrodynamics',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Fluid kinetics',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Pipe flow',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Flow measurement in channels',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Fm1({required this.fullName}); // Constructor accepting fullName
