...
class Ct1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Building Construction I',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Building Construction II',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title:
          'MODULE III: Building Services and Vertical Transportation Systems',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Construction Technology',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Structural Systems and Building Protection',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Ct1({required this.fullName}); // Constructor accepting fullName
