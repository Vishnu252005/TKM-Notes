...
class sa1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Trusses, Arches and Cables',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Deflection of statically determinate structures',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Analysis of Statically Indeterminate Structures ',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Plastic Analysis',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Introduction to Structural Dynamics',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  sa1({required this.fullName}); // Constructor accepting fullName
