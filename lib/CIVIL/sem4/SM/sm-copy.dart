...
class Sm1 extends StatefulWidget {
  ...
  @override
  _SmState createState() => _SmState();
}

class _SmState extends State<Sm1> {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Basic soil properties',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Index properties',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Effective stress and Vertical stress',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Engineering properties – Consolidation and compaction',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Engineering properties – Shear strength',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
