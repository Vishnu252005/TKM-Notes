...
class Dmri1 extends StatefulWidget {
  ...
  @override
  _DmriState createState() => _DmriState();
}

class _DmriState extends State<Dmri1> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Fundamental concepts of Hazards and Disasters',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Disaster Risk Management',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Disaster Management Policies',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Seismic Design Considerations',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Flood Resistant Technologies',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
