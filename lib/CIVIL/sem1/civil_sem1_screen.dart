...
import 'package:flutter_application_2/CIVIL/sem1/SPORTS/sports.dart'; // Import the correct file for units
...
class CIVILSem1Screen extends StatefulWidget {
  ...
  @override
  _CIVILSem1ScreenState createState() => _CIVILSem1ScreenState();
}

class _CIVILSem1ScreenState extends State<CIVILSem1Screen> {
  ...
  _subjects = {
    'Notes & Books': [
      ...
      },
      {
        ...
        'image': 'assets/s1.png',
        'page': () => Mechanic(fullName: widget.fullName),
      },
      {
    ...
    'PYQs': [
      ...
      },
      {
        ...
        'image': 'assets/s2.png',
        'page': () => Mechanic1(fullName: widget.fullName),
      },
      {
