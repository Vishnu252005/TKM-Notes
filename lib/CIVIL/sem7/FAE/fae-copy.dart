...
class Fae1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: (Introduction to Accounting)',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: (Construction Accounts Management)',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: (Financing of Construction Projects)',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: (Construction Economics)',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: (Methods of Economic decision making)',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Fae1({required this.fullName}); // Constructor accepting fullName
