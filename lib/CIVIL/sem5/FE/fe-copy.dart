...
class Fe1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Foundation Type & Site Investigation',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Bearing capacity of shallow foundations',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Settlement of Shallow foundation',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Deep Foundation',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Earth Pressure theory & Slope Stability',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Fe1({required this.fullName}); // Constructor accepting fullName
