...
class hwre1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Surface Water Hydrology-Rainfall and losses',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Surface Water Hydrology-Runoff',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Irrigation Engineering',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Reservoir Engineering',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Groundwater Hydrology',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  hwre1({required this.fullName}); // Constructor accepting fullName
