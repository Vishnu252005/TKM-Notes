...
class Ds1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE III: Design of Slabs',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Design of Columns',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Design of Stairs and Footings',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Ds1({required this.fullName}); // Constructor accepting fullName
