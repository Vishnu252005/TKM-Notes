...
class Manufact1 extends StatefulWidget {
  ...
  @override
  _Manufact1State createState() => _Manufact1State();
}

class _Manufact1State extends State<Manufact1> {
