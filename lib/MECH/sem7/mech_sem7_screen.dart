...
import 'package:flutter_application_2/MECH/sem7/units.dart';  // Import the correct file for units
import 'package:flutter_application_2/widgets/profile.dart'; // Import the profile.dart file

class MECHSem7Screen extends StatefulWidget {//t
  final String fullName;
  final String branch;
  final String year;
  final String semester;

  const MECHSem7Screen({
    Key? key,
  ...
  @override
  _MECHSem7ScreenState createState() => _MECHSem7ScreenState();
}

class _MECHSem7ScreenState extends State<MECHSem7Screen> {
  ...
  _subjects = {
    ...
    'PYQs': [
      {
        'name': 'Refrigeration and Air Conditioning PYQs',
        'description': 'Previous Year Questions for Refrigeration and Air Conditioning...',
        'image': 'assets/s2.png',
        'page': () => ComputerNetworksPage(fullName: widget.fullName),
      },
      {
        'name': 'Product Innovation & Entrepreneurship PYQs',
        'description': 'Previous Year Questions for Product Innovation & Entrepreneurship...',
        'image': 'assets/s2.png',
        'page': () => ComputerNetworksPage(fullName: widget.fullName),
      },
    ],
