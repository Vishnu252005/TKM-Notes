...
class Rac1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE II: Vapor Compression Refrigeration (VCR) System',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Vapor Absorption Systems',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Psychrometry',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Air-Conditioning Systems' ,
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Rac1({required this.fullName}); // Constructor accepting fullName
