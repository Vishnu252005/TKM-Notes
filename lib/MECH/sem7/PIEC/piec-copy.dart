...
class Piec1 extends StatefulWidget {
  ...
  @override
  _PiecState createState() => _PiecState();
}

class _PiecState extends State<Piec1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Entrepreneurship',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Product Innovation',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Product Development',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Marketing & Finance',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Venture Creation',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
