...
class At1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Power cycles',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Steam turbines',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Compressors',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Basics of compressible flow',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Combustion',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  At1({required this.fullName}); // Constructor accepting fullName
