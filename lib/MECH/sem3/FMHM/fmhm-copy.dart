...
class Fmhm1 extends StatefulWidget {
  ...
  @override
  _FmhmState createState() => _FmhmState();
}

class _FmhmState extends State<Fmhm1> {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Properties of Fluid',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Fluid Kinematics',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Laminar and Turbulent Flow',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Impact of Jets',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
