...
class Mmt extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title:
          'MODULE I: Fundamentals of Engineering Materials and Atomic Structure',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
  ...
  Mmt({required this.fullName}); // Constructor accepting fullName
