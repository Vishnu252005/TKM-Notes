...
class Mmt extends StatefulWidget {
  ...
  @override
  _MmtState createState() => _MmtState();
}

class _MmtState extends State<Mmt> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Fundamentals of Engineering Materials and Atomic Structure',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Crystallography and Phase Diagrams',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Deformation, Fracture, and Fatigue in Materials',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Composite materials',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Superconducting phenomenons in Materials',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
