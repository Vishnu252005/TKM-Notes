...
class Ema1 extends StatefulWidget {
  ...
  @override
  _EmaState createState() => _EmaState();
}

class _EmaState extends State<Ema1> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Engineering Materials & Classifications',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Metals & Alloys',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Heat treatment of Steel',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Polymers',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Conductive and Resistive Materials',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
