...
class _IemState extends State<Iem1> {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Introduction to Industrial Engineering',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Introduction to Management',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Plant Layout and Material Handling',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Methods Engineering, Industrial Relations',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Production Planning and Control',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
