...
class Se extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Foundations of Sustainability',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Energy Sources and Technologies',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Environmental Management and Industrial Ecology',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Sustainable Design Principles',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Energy Conservation and Emission Control in Industry',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Se({required this.fullName}); // Constructor accepting fullName
