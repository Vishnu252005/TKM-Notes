...
class Is extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE III: Plant layout for safety, Safe working conditions',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Principles of health and safety ',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
  ...
  Is({required this.fullName}); // Constructor accepting fullName
