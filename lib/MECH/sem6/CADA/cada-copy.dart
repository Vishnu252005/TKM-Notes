...
class Cada1 extends StatefulWidget {
  ...
  @override
  _CadaState createState() => _CadaState();
}

class _CadaState extends State<Cada1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Introduction and Transformations',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Curves and Surfaces',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Solid Modelling',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Engineering Analysis using FEM',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: CFD and Design Optimization',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
