...
class Kdm1 extends StatefulWidget {
  ...
  @override
  _KdmState createState() => _KdmState();
}

class _KdmState extends State<Kdm1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Basics of Mechanisms',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Kinematic analysis of mechanisms',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Static and Dynamic analysis of mechanisms',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Gear trains and Mass balancing',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Mechanical vibrations in systems',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
