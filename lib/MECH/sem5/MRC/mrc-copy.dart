...
class Mrc1 extends StatefulWidget {
  ...
  @override
  _MrcState createState() => _MrcState();
}

class _MrcState extends State<Mrc1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Introduction to mechatronics.',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Actuators',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Machine Controls',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Control Theory and Systems',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Robotics',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
