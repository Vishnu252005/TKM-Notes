...
class Or1 extends StatefulWidget {
  ...
  @override
  _OrState createState() => _OrState();
}

class _OrState extends State<Or1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Introduction to Operations Research',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Special cases in simplex method application',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Transportation problem',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Game theory',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Queueing models',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
