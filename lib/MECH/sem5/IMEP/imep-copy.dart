...
class Imep1 extends StatefulWidget {
  ...
  @override
  _ImepState createState() => _ImepState();
}

class _ImepState extends State<Imep1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Mechanical',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Electricals',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Plumbing',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Firefighting Systems',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: MEP Drawings',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
