...
class Mesd1 extends StatefulWidget {
  ...
  @override
  _MesdState createState() => _MesdState();
}

class _MesdState extends State<Mesd1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Introduction to Design',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Design for fluctuating loads',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Design of Shafts',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Design of Gears',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Design of Bearings',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
