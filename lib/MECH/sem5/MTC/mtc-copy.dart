...
class Mtc1 extends StatefulWidget {
  ...
  @override
  _MtcState createState() => _MtcState();
}

class _MtcState extends State<Mtc1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Definition and significance of engineering materials',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Introduction to Mechanical testing',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Introduction to material behaviour',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Fracture',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Non-destructive techniques',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
