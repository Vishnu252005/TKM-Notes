...
class Httm1 extends StatefulWidget {
  ...
  @override
  _HttmState createState() => _HttmState();
}

class _HttmState extends State<Httm1> {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Conduction Heat Transfer',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Convection Heat Transfer',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Radiation Heat Transfer',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Heat Exchanger Design',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Introduction to mass transfer',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
