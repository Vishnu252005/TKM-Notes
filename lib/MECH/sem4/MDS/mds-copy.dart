...
class Mds1 extends StatefulWidget {
  ...
  @override
  _MdsState createState() => _MdsState();
}

class _MdsState extends State<Mds1> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Concept of Stress and Strain',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Axially loaded bars',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Torsion of Circular Shafts, Shear Force and Bending Moment',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Bending of beams',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Column Buckling and Combined Loading',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
