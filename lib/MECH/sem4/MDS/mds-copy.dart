...
class Mds1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title:
          'MODULE III: Torsion of Circular Shafts, Shear Force and Bending Moment',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
  ...
  Mds1({required this.fullName}); // Constructor accepting fullName
