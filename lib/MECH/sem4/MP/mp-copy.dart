...
class Mp1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Manufacturing Processes and Classification',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Material Shaping Processes contd..',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Material Removal Processes',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Joining Processes',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Additive Manufacturing Processes',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Mp1({required this.fullName}); // Constructor accepting fullName
