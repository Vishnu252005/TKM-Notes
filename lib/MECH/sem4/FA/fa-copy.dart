...
import 'package:flutter_application_2/EEE/sem4/FA/fa-copy.dart';
...
class Fa1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I:  Foundations of Bookkeeping and Accounting',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Financial Statements and Accounting Software',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Financial Management and Analysis',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Banking and Financial Operations',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Budgeting and Financial Planning',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
                  ...
                  builder: (BuildContext context, double value, Widget? child) {
                    return Transform.translate(
                      ...
                      child: Column(
                        ...
                        children: const [
                          Text(
                            'Management – I (Finance and Accounting)',
                            style: TextStyle(
                                fontSize: 24,
