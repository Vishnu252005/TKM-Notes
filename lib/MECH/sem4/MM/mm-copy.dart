...
import 'package:flutter_application_2/MECH/sem3/MM/mm-copy.dart';
...
class Mm1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Measurement Purpose and Parameters',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Limits, Fit and Tolerances',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Form and Surface Metrology',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Electrical Measurements and Instruments',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Design of Experiments and Statistical Analysis',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Mm1({required this.fullName}); // Constructor accepting fullName
