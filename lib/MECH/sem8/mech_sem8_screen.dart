...
import 'package:flutter_application_2/MECH/sem8/units.dart';  // Import the correct file for units
import 'package:flutter_application_2/widgets/profile.dart'; // Import the profile.dart file

class MECHSem8Screen extends StatefulWidget {
  final String fullName;
  final String branch;
  final String year;
  final String semester;

  const MECHSem8Screen({
    Key? key,
  ...
  @override
  _MECHSem8ScreenState createState() => _MECHSem8ScreenState();
}

class _MECHSem8ScreenState extends State<MECHSem8Screen> {
