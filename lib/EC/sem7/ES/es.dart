...
class Es extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Power System Network Modelling',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Short Circuit Analysis',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Load Flow Analysis',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
    ...
    UnitItem(
      title: 'MODULE V: Economics of Power Generation',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
