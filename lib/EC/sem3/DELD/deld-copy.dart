...
class Deld1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title:
          'MODULE V: State Machines, D/A and A/D Converters, Programmable Logic Devices',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Deld1({required this.fullName}); // Constructor accepting fullName
