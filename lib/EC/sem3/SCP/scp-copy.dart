...
class Scp1 extends StatefulWidget {
  ...
  @override
  _Scp1State createState() => _Scp1State();
}

class _Scp1State extends State<Scp1> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Fundamental Programming with Python',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Numerical Python for Linear Algebra',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Advanced Python Techniques',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Data Analysis and Visualization',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Signal Processing and Statistics',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
