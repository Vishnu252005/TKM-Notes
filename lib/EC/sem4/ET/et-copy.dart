...
import 'package:flutter_application_2/EEE/sem4/ET/et-copy.dart';
...
class Et1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: DC Machines',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Transformers',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Induction Machines',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Synchronous Machines',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Single Phase Motor and Special Electrical Machines',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Et1({required this.fullName}); // Constructor accepting fullName
