...
class Ssedc1 extends StatefulWidget {
  ...
  @override
  _SsedcState createState() => _SsedcState();
}

class _SsedcState extends State<Ssedc1> {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: h-parameter model of ce amplifier, biasing of JFET and MOSFET amplifiers',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Frequency response of Amplifiers, Multistage amplifiers and Power amplifiers',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Feedback in amplifiers and basics of OPAMP',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Operational amplifier circuits',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Waveform generation and Introduction to CMOS',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
