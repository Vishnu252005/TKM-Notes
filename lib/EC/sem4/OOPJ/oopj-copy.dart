...
class Oopj1 extends StatefulWidget {
  ...
  @override
  _OopjState createState() => _OopjState();
}

class _OopjState extends State<Oopj1> {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE II: Core Java Fundamentals',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Object Creation and Inheritance',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Polymorphism and Interface',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Exception Handling and Multithreading',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
