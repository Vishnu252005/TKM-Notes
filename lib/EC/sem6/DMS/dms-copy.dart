...
class Dms1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Introduction & Entity Relationship (ER) Model',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Relational Model',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: SQL DML (Data Manipulation Language) &Physical Data Organization',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Normalization',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Transactions, Concurrency and Recovery',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

 Dms1({required this.fullName}); // Constructor accepting fullName
