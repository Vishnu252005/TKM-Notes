...
class Ped1 extends StatefulWidget {
  ...
  @override
  _PedState createState() => _PedState();
}

class _PedState extends State<Ped1> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Power semiconductor devices',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Line commutated converters',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: AC Voltage Controllers and Inverters',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: DC-DC Converters',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Power Electronic Control of Electric Drives',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
