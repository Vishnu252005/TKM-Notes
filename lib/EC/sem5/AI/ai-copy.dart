...
class _AiState extends State<Ai1> {
  bool _isDarkMode = true; // Default to dark mode
  String _searchQuery = '';

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Fundamentals to probabilistic reasoning in AI',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Introduction to AI',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Problem Solving',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Introduction to neural networks',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Machine Learning',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
