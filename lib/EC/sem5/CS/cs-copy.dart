...
class _CsState extends State<Cs1> {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Modelling of Physical Systems',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Time Domain Analysis',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Root Locus Construction and Compensator Design',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Frequency Domain Analysis',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Compensator Design in Frequency Domain',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
  ...
  Widget build(BuildContext context) {
    final filteredUnits = units.where((unit) =>
        unit.title.toLowerCase().contains(_searchQuery.toLowerCase())).toList();
          ...
          child: Padding(
            ...
            child: TextField(
              decoration: InputDecoration(
                hintText: 'Search',
                hintStyle: TextStyle(color: _isDarkMode ? Colors.white70 : Colors.blue[700]),
                  ...
                  child: Padding(
                    ...
                    child: ListView(
                      children: [
                        ...
                        ...filteredUnits.map((unit) => _buildListItem(context, unit.title, unit.isAvailable, unit.pdfUrl)).toList(),
                      ],
                    ),
                  ),
                ),
