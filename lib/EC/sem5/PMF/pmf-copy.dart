...
class Pmf1 extends StatefulWidget {
  ...
  @override
  _PmfState createState() => _PmfState();
}

class _PmfState extends State<Pmf1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Fundamental concepts of Project Management',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Project Scheduling',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: MS Project',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Primavera software',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Finance Management',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
