...
class Ma1 extends StatelessWidget {
  ...
  UnitItem(
    title: 'MODULE II: Array of Point Sources',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_2',
  ),
  UnitItem(
    title: 'MODULE III: Broadband Antenna',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_3',
  ),
  UnitItem(
    title: 'MODULE IV: Microwave Oscillators and Amplifiers',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_4',
  ),
  UnitItem(
    title: 'MODULE V: Microwave Hybrid Circuits and Devices',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_5',
  ),
];
  ...
  Ma1({required this.fullName}); // Constructor accepting fullName
