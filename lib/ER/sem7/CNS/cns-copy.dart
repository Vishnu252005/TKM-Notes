...
class Cns1 extends StatefulWidget {
  ...
  @override
  _CnsState createState() => _CnsState();
}

class _CnsState extends State<Cns1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Introduction to Data Communication',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Data Link Layer',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Network Layer',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Transport and Application Layer',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Network Security',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
