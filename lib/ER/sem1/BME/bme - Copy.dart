...
class bme1 extends StatefulWidget {
  final String fullName;
  final String branch;
  final String year;
  final String semester;

  bme1({required this.fullName, required this.branch, required this.year, required this.semester});

  @override
  _bme1State createState() => _bme1State();
}

class _bme1State extends State<bme1> {
