...
class Ca1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
  UnitItem(
    title: 'MODULE I: Introduction to Computer System',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_1',
  ),
  UnitItem(
    title: 'MODULE II: Memory Architecture',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_2',
  ),
  UnitItem(
    title: 'MODULE III: I/O Organization',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_3',
  ),
  UnitItem(
    title: 'MODULE IV: Processing Unit',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_4',
  ),
  UnitItem(
    title: 'MODULE V: Processor Operation',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_5',
  ),
];
  ...
  Ca1({required this.fullName}); // Constructor accepting fullName
