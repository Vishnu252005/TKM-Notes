...
import 'package:flutter_application_2/EC/sem3/NT/nt-copy.dart';
import 'package:flutter_application_2/widgets/profile.dart';
import 'package:flutter_application_2/widgets/pdfviewer.dart';

class Nt1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
  UnitItem(
    title: 'MODULE I: Mesh and Node Analysis',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_1',
  ),
  UnitItem(
    title: 'MODULE II: Network Theorems',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_2',
  ),
  UnitItem(
    title: 'MODULE III: S domain Analysis',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_3',
  ),
  UnitItem(
    title: 'MODULE IV: Network functions',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_4',
  ),
  UnitItem(
    title: 'MODULE V: Two port network',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_5',
  ),
];
  ...
  Nt1({required this.fullName}); // Constructor accepting fullName
