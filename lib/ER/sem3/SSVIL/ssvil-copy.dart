...
class Ssvil1 extends StatefulWidget {
  ...
  @override
  _SsvilState createState() => _SsvilState();
}

class _SsvilState extends State<Ssvil1> {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Introduction to Electrical Circuit Simulation',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Introduction to MATLAB',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Creating subsystems using MATLAB/SIMULINK',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
    ...
    UnitItem(
      title: 'MODULE V: Introduction to Virtual Instrumentation',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
