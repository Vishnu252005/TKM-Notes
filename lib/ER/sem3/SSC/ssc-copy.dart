...
class Ssc1 extends StatefulWidget {
...
class _SscState extends State<Ssc1> {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Introduction to measurements and sensors',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Temperature and flow sensor',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Optical sensor',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Optical sensor',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Signal conditioning',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
