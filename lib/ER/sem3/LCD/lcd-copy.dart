...
class Lcd1 extends StatefulWidget {
...
class _LcdState extends State<Lcd1> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Number Systems and Codes',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Boolean Postulates and Fundamental Gates',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Combinational and Arithmetic Circuits',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Sequential Logic Circuits',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Finite State Machines and Logic families',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
