...
class Mi1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
  UnitItem(
    title: 'MODULE I: Introduction to Machine Learning and Applications',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_1',
  ),
  UnitItem(
    title: 'MODULE II: Supervised Learning Techniques and Signal Processing',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_2',
  ),
  UnitItem(
    title: 'MODULE III: Unsupervised Learning and Feature Extraction',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_3',
  ),
  UnitItem(
    title: 'MODULE IV: Neural Networks and Deep Learning',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_4',
  ),
  UnitItem(
    title: 'MODULE V: Advanced Topics and Real-world Applications',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_5',
  ),
];
  ...
  Mi1({required this.fullName}); // Constructor accepting fullName
                  ...
                  builder: (BuildContext context, double value, Widget? child) {
                    return Transform.translate(
                      ...
                      child: Column(
                        ...
                        children: const [
                          Text(
                            'Machine Intelligence: Methods and Applications',
