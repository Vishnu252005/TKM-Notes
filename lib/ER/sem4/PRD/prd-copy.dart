...
class Prd1 extends StatefulWidget {
  ...
  @override
  _PrdState createState() => _PrdState();
}

class _PrdState extends State<Prd1> {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE III: Joint Probability Distributions',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Test of Hypotheses',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Random Processes',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
