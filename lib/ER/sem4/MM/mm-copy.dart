...
class Mm1 extends StatefulWidget {
...
class _MmState extends State<Mm1> {
  bool _isDarkMode = true;

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Architecture and Programming of 8085 Microprocessor',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Architecture of 8051 Microcontroller',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Programming of 8051 Microcontroller',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Interfacing of 8051 Microcontroller',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Interfacing and Advanced Concepts',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
