...
import 'package:flutter_application_2/EEE/sem5/IEM/iem-copy.dart';
...
class Iem1 extends StatelessWidget {
  final String fullName; // Full name received as a parameter
  final List<UnitItem> units = [
  UnitItem(
    title: 'MODULE I: Basic Concepts and Demand and Supply Analysis',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_1',
  ),
  UnitItem(
    title: 'MODULE II: Production and cost concepts',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_2',
  ),
  UnitItem(
    title: 'MODULE III: Introduction to management',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_3',
  ),
  UnitItem(
    title: 'MODULE IV: Management process',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_4',
  ),
  UnitItem(
    title: 'MODULE V: Productivity and Project Management',
    isAvailable: true,
    pdfUrl: 'url_to_pdf_5',
  ),
];
  ...
  Iem1({required this.fullName}); // Constructor accepting fullName
