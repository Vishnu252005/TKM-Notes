...
class Ac1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: MOSFET Amplifier',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Small Signal Analysis',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Feedback Amplifiers',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title:
          'MODULE IV: Differential Amplifiers',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Design of Operational AmplifiersDifferential Amplifiers',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Ac1({required this.fullName}); // Constructor accepting fullName
