...
class Iia1 extends StatefulWidget {
  ...
  @override
  _IiaState createState() => _IiaState();
}

class _IiaState extends State<Iia1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Introduction to Instrumentation',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Sensors and Transducers',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Signal Transmission and Telemetry',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Programmable Logic Controllers',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: SCADA & DCS',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
