...
class Vlsid extends StatefulWidget {
  ...
  @override
  _VlsidState createState() => _VlsidState();
}

class _VlsidState extends State<Vlsid> {
  ...
  final List<UnitItem> units = [
    ...
    UnitItem(
      title: 'MODULE II: Static and Dynamic CMOS logic',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Delay and Interconnect',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Circuit and Subsystem Design',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: VLSI Fabrication',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
