...
class Aet1 extends StatefulWidget {
  ...
  @override
  _AetState createState() => _AetState();
}

class _AetState extends State<Aet1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Introduction to Electromagnetics',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Propagation of Waves through Various Media',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Waves at Media Interface',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Transmission Lines',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Waveguides',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
