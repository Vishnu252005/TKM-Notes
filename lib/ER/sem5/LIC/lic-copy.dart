...
class Lic1 extends StatefulWidget {
  ...
  @override
  _LicState createState() => _LicState();
}

class _LicState extends State<Lic1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Fundamentals of Operational Amplifier',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Op-amp Applications',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Op-amp Circuits',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Voltage Controlled Oscillator (VCO) and Phase Locked Loop',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Data Converters',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
