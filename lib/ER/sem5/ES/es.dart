...
class Es extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Foundations of Entrepreneurship',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Ideation and Conceptualization',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Startup Financing and Legalities',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title:
          'MODULE IV: Product Development and Marketing',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Growth, Scaling, and the Startup Ecosystem',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Es({required this.fullName}); // Constructor accepting fullName
