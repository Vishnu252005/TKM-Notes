...
class Cs1 extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Modelling of Control Systems',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Analysis of Control Systems',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Stability of Control Systems',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title:
          'MODULE IV: Frequency domain Methods and Compensator Design',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: State space analysis',
      isAvailable: false,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
