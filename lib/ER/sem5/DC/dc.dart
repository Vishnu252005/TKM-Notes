...
class Dc extends StatelessWidget {
  ...
  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Overview of Random Variables and Random Process',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: Baseband Data Transmission',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: Transmission over Baseband Channel',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title:
          'MODULE IV: Signal Space Analysis',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Pass Band Data Transmission',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];

  Dc({required this.fullName}); // Constructor accepting fullName
