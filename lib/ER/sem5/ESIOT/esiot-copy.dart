...
class Esiot1 extends StatefulWidget {
  ...
  @override
  _EsiotState createState() => _EsiotState();
}

class _EsiotState extends State<Esiot1> {
  bool _isDarkMode = true; // Default to dark mode

  final List<UnitItem> units = [
    UnitItem(
      title: 'MODULE I: Introduction to Embedded Systems',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_1',
    ),
    UnitItem(
      title: 'MODULE II: RISC V Processor Architecture',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_2',
    ),
    UnitItem(
      title: 'MODULE III: RISC V Memory Model and Pipelining',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_3',
    ),
    UnitItem(
      title: 'MODULE IV: Real Time Operating System',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_4',
    ),
    UnitItem(
      title: 'MODULE V: Internet of Things',
      isAvailable: true,
      pdfUrl: 'url_to_pdf_5',
    ),
  ];
